...
export default {
  ...
  data() {
    return {
      ...
      showSearch: false,
      links: [
        [ 'mdi-home', 'TOP', "/partner/partner"],
        ['mdi-menu', 'アイテム',"/partner/item/list"],
        ['mdi-account-supervisor-circle', '注文履歴', "/partner/chumonrireki/list"],
        ['mdi-alert-octagon', 'お問い合わせ', "/partner/otoiawase/list"],
      ],
